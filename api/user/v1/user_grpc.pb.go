...
func (c *userServiceClient) ListUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListUserReply, error) {
...
func (UnimplementedUserServiceServer) ListUser(context.Context, *emptypb.Empty) (*ListUserReply, error) {
